...
- (void)drawRect:(NSRect)dirtyRect
{
    ...
    NSDictionary *textFontAttributes = @{
        NSFontAttributeName : [NSFont fontWithName:@"Helvetica" size:18],
    ...
    auto nom = [NSString stringWithCString:oss.str().c_str()
...
- (void)sliderChanged
{
    ...
    BaconPaul::StupiSaw::FromUI f{.id = BaconPaul::StupiSaw::pmCutoff, .value = v};
